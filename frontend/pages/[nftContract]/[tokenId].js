...
export default function NFTDetails() {
  ...
  const MarketplaceContract = useContract({
    ...
    async function fetchListing() {
        ...
        // If no active listing is found with the given parameters, inform user of the error, then redirect to homepage
    ...
    // function to fetch NFT details from its metadata, similar to the one in the listing
    ...
    // function to call update listing in the smart contract
    async function updateListing() {
        setUpdating(true);
        const updateTxn = await MarketplaceContract.updateListing(nftAddress, tokenId, parseEther(newPrice));
    ...
    // function to call the 'cancelListing' in the smart contract
    ...
    async function buyListing() {
        setBuying(true);
        const buyTxn = await MarketplaceContract.purchaseListing(nftAddress, tokenId, { value: listing.price });
        await buyTxn.wait();
        await fetchListing();
        setBuying(false);
    }
